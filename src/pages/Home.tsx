...
export function Home() {
	const [demoStep, setDemoStep] = useState<'idle' | 'playing' | 'completed'>(
		'idle'
	)
					...
					<div className='space-y-8'>
						...
						<SlideIn direction='up' delay={0.2}>
							<p className='text-xl text-muted-foreground max-w-lg'>
								Create, share, and take quizzes on any topic. Learn while having
								fun with our interactive quiz platform designed for everyone.
							</p>
						</SlideIn>
							...
							<CardContent className='relative p-8 space-y-6'>
								...
								{demoStep === 'playing' && (
									...
									>
										...
										<div className='space-y-3'>
											{demoQuestions[currentQuestion].options.map(
												(option, idx) => (
													<motion.button
														key={idx}
														whileHover={{
														...
														onClick={() =>
															selectedAnswer === null && handleAnswerSelect(idx)
														}
					...
					{[
						{
							...
							description:
								'Create quizzes instantly with our intelligent quiz generator',
							delay: 0,
						},
						{
							icon: Users,
							...
							description:
								'Make your quizzes public or keep them private for specific groups',
							delay: 0.1,
						},
						{
							icon: Trophy,
							...
							description:
								'Monitor your improvement with detailed analytics and scores',
							delay: 0.2,
						},
						{
							icon: Zap,
						...
						},
						{
							...
							description:
								'Enjoy a modern, clean design that makes learning fun',
							delay: 0.4,
						},
						{
							icon: CheckCircle,
							...
							description:
								'Support for various question formats and difficulty levels',
							delay: 0.5,
						},
					].map((feature, idx) => (
