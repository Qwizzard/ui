...
import { CheckCircle2, XCircle, Globe, Lock, Share2, Trophy, Target, TrendingUp, RotateCcw } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
        ...
        <Card className="relative overflow-hidden border-2">
          ...
          <CardContent className="relative pt-12 pb-8">
            ...
            <div className="mx-auto w-32 h-32 mb-6 relative">
              <LottieAnimation 
                animationType={result.percentage >= 70 ? 'celebration' : 'tryAgain'}
            ...
            <div className="text-center space-y-4">
              ...
              >
                <h2 className="text-2xl font-semibold mb-2">{result.quizTopic}</h2>
              ...
              >
                ...
                <Badge variant="outline" className={cn('text-xl px-4 py-2', color)}>
                  Grade: {grade}
                </Badge>
      ...
      <div className="space-y-4">
        <FadeIn delay={1.3}>
          ...
          <p className="text-muted-foreground">Review each question and learn from your mistakes</p>
        </FadeIn>
                      ...
                      >
                        <div className="flex items-center justify-between gap-3">
                          <span className={cn(
                            ...
                            isSelected && !isCorrect && 'text-red-700 dark:text-red-400'
                          )}>
                            {option}
                          </span>
                          {isCorrect && (
